  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Prerequisites</h1>
              ...
              <div className="border-l-4 border-purple-200 pl-4">
                <h3 className="text-lg font-semibold text-gray-900">
                  <a href="https://git-scm.com/downloads" 
                     className="text-purple-600 hover:underline" target="_blank" rel="noopener noreferrer">
                    Git
                  </a>
                </h3>
                <p className="text-gray-600 mt-2">
              ...
              <div className="border-l-4 border-orange-200 pl-4">
                <h3 className="text-lg font-semibold text-gray-900">
                  <a href="https://github.com/mjansen4857/pathplanner/releases" 
                     className="text-orange-600 hover:underline" target="_blank" rel="noopener noreferrer">
                    PathPlanner
                  </a>
                </h3>
                <p className="text-gray-600 mt-2">
              ...
              <div className="border-l-4 border-red-200 pl-4">
                <h3 className="text-lg font-semibold text-gray-900">
                  <a href="https://github.com/Gold872/elastic-dashboard" 
                     className="text-red-600 hover:underline" target="_blank" rel="noopener noreferrer">
                    Elastic Dashboard
                  </a>
                </h3>
                <p className="text-gray-600 mt-2">
              ...
              <div className="border-l-4 border-yellow-200 pl-4">
                <h3 className="text-lg font-semibold text-gray-900">
                  <a href="https://www.codecademy.com/learn/learn-java" 
                     className="text-yellow-600 hover:underline" target="_blank" rel="noopener noreferrer">
                    Java Knowledge
                  </a>
                </h3>
                <p className="text-gray-600 mt-2">
          ...
          <div className="bg-white rounded-lg p-6 shadow-lg border">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Kraken</h3>
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-4xl mb-3">🎯</div>
                <h3 className="font-semibold text-gray-900 mb-2">CANCoder</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-4xl mb-3">🌐</div>
                <h3 className="font-semibold text-gray-900 mb-2">CANivore</h3>
                <p className="text-sm text-gray-600">
